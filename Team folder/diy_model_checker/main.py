# diy model checker for sismic based state charts
# not efficient but (hopefully) easy to understand
#
# Developed for sysmod 2020 class in University of Tartu
#
# author: ulno
...
def reachability(state_machine, transitions=None):
    ...
    :param state_machine: the state machine for which to build the reacability graph
...
def main():
    ...
    state_chart = import_from_yaml(filepath="battery.yaml")
